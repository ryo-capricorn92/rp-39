...
returns an array of the lengths of each word in the string. Rewrite wordLengths
using each (written above for your convenience); that is, replace the for
loop.
...
// => [ 3, 5, 5, 3, 5, 4, 3, 4, 4 ]
//2
/*wordLengths involves transforming every word into its length,
...
Using map (also written above for convenience), rewrite wordLengths
 (but write a new function, e.g. wordLengthsMap) again -- but
 this time using map.*/
